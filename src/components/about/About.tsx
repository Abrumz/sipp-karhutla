...
import { Info, Map, Book, Mail, Phone, Building, Award, FileText, Users } from 'lucide-react';
                                ...
                                <div className="mb-6">
                                    ...
                                    <div className="pl-8 border-l-2 border-blue-100">
                                        <p className="text-gray-700 mb-4 leading-relaxed">
                                            SIPP Karhutla dibangun oleh Departemen Ilmu Komputer, Fakultas Matematika dan Ilmu
                        ...
                        <div className="bg-white rounded-xl shadow-md overflow-hidden">
                            ...
                            <div className="p-6">
                                <div className="flex items-start mb-6 hover:bg-blue-50 p-3 rounded-lg transition-colors duration-200">
                                    ...
                                    <div>
                                        <h3 className="font-medium text-gray-800">Departemen Ilmu Komputer, FMIPA IPB</h3>
                                        <p className="text-gray-600">Jl. Meranti Wing 20 Level V, Bogor, Indonesia 16680</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start mb-6 hover:bg-blue-50 p-3 rounded-lg transition-colors duration-200">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">karhutla.ipb@apps.ipb.ac.id</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start hover:bg-blue-50 p-3 rounded-lg transition-colors duration-200">
                                    ...
                                    <div>
                                        <h3 className="font-medium text-gray-800">Telepon/Fax</h3>
                                        <p className="text-gray-600">0251- 8625584</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-white rounded-xl shadow-md p-6 mb-8">
                        <div className="flex flex-col md:flex-row items-center justify-between">
                            <div className="flex items-center mb-4 md:mb-0">
                                ...
                                <div>
                                    <h3 className="text-lg font-semibold text-gray-800">Punya Pertanyaan?</h3>
