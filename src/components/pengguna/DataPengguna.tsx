        ...
        <div className="bg-gray-50 min-h-full p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8 max-w-7xl mx-auto">
                <InfoCard
                    ...
                    title="Data Pengguna Terpadu"
                    description="Akses informasi lengkap semua pengguna dalam satu sistem terpadu"
                    color="blue"
                />
                <InfoCard
                    icon={
                    ...
                    description="Tetapkan dan kelola hak akses pengguna berdasarkan peran dan organisasi"
                    color="indigo"
                />
                <InfoCard
                    icon={
                    ...
                    description="Pantau dan kelola akses pengguna untuk menjaga keamanan data sistem"
                    color="purple"
                />
            </div>
                                    ...
                                    {paginatedData.length > 0 ? (
                                        paginatedData.map((user, index) => (
                                            <tr key={user.id} className="hover:bg-gray-50">
                                                <td className="px-6 py-4 whitespace-nowrap text-l text-gray-800">{user.name || '-'}</td>
                                                <td className="px-6 py-4 whitespace-nowrap text-l text-gray-800">{user.registrationNumber || '-'}</td>
                                                <td className="px-6 py-4 whitespace-nowrap text-l text-gray-800">{user.email || '-'}</td>
                                                <td className="px-6 py-4 whitespace-nowrap text-l text-gray-800">{user.phoneNumber || '-'}</td>
                ...
                <div className="fixed inset-0 z-50 overflow-auto bg-black bg-opacity-50 flex items-center justify-center">
                    <div className="bg-white rounded-lg w-full max-w-md mx-4 md:mx-auto shadow-xl">
                        <div className="flex justify-between items-center px-6 py-4 border-b">
                            <h4 className="text-lg font-semibold text-gray-800">Tambah Hak Akses</h4>
                            <button
