        ...
        <div className="bg-gray-50 min-h-full p-6">
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
                    <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md">
                        <div className="flex justify-between items-center mb-4">
                            <h3 className="text-lg font-semibold text-gray-800">Edit Penugasan</h3>
                            <button
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8 max-w-7xl mx-auto">
                <InfoCard
                    ...
                    title="Kelola Dokumen Penugasan"
                    description="Lihat dan kelola semua dokumen penugasan patroli dalam sistem"
                    color="blue"
                />
                <InfoCard
                    icon={
                    ...
                    description="Tambahkan dokumen penugasan patroli baru ke dalam sistem"
                    color="indigo"
                />
                <InfoCard
                    icon={
                    ...
                    description="Akses informasi lengkap untuk setiap dokumen penugasan"
                    color="purple"
                />
            </div>
                        ...
                        <div className="overflow-x-auto">
                            <table className="min-w-full divide-y divide-gray-200">
                                <thead className="bg-gray-50">
                                    <tr>
                                        {columns.map((column) => (
                                            <th key={column.field} scope="col" className="px-6 py-3 text-left text-l font-medium text-gray-500 uppercase tracking-wider">
                                                {column.title}
                                            </th>
                                        ))}
