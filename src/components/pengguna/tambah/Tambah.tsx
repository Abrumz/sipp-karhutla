...
const Tambah: React.FC<TambahProps> = () => {
    ...
    const handleChange = (prop: string) => (event: ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
        setFormData({
            ...formData,
        ...
        <div className="bg-gray-50 min-h-full p-6">
            ...
            <div className="max-w-5xl mx-auto p-6 bg-white rounded-xl shadow mb-8">
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        <h3 className="font-semibold text-gray-800 mb-2">Informasi Pendaftaran</h3>
